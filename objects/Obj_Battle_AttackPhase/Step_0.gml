...
if(keyboard_check_pressed(ord("D"))){
	...
	if(!instance_exists(Obj_Battle_Actor_Attack) && obj[0]._ap>0){
...
if(keyboard_check_pressed(ord("W"))){
	...
	if(!instance_exists(Obj_Battle_Actor_Attack) && obj[1]._ap>0){
		//audio_play_sound(Sound_Cursor,0,0);
		attacker = 1;
		instance_create_depth(0,0,0,Obj_Battle_Actor_Attack);
	}
...
if(keyboard_check_pressed(ord("S"))){
	...
	if(!instance_exists(Obj_Battle_Actor_Attack) && obj[2]._ap>0){
		//audio_play_sound(Sound_Cursor,0,0);
		attacker = 2;
		instance_create_depth(0,0,0,Obj_Battle_Actor_Attack);
	}
